                                    ...
                                    echo    '<div class="col-lg-8">
                                            ...
                                            <div class="">
                                                ...
                                                <form method="post" action="Apply.php">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            <textarea class="form-control" rows="5" placeholder="Cover Letter" name="cLetter" required></textarea>
                                                        </div>
                                                        <input type="number" name="jobId" value="'.$jobId.'" style="display: none;">
                                                        <input type="number" name="recruiterId" value="'.$recruiterId.'" style="display: none;">
                                                        <div class="col-12">
                                                            <button class="btn btn-primary w-100" type="submit" name="apply" required>Apply Now</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                                                ...
                                                <p class="m-0">'.$companyDetail.'</p></br></br>
                                                <a  class="btn btn-primary w-100" href="ViewRecruiterProfile.php?recruiterId='.$recruiterId.'">View Recruiter Profile</a></br></br>
                                            </div>
                                        </div>';
                                }
                                else{
                                            ...
                                            <div class="">
                                                ...
                                                <form method="" action="">
                                                    <div class="row g-3">
                                                        ...
                                                        <input type="number" name="recruiterId" value="'.$recruiterId.'" style="display: none;">
                                                        <div class="col-12">
                                                            <a href="LoginAsTalent.php"><button class="btn btn-primary w-100" type="button">Apply Now</button></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
