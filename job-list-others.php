...
<head>
    <meta charset="utf-8">
    <title>JobEntry - Jobs - Others</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Jobs - Others</h1>
            </div>
        </div>
        <!-- Header End -->
        ...
        <!-- Jobs Start -->
            <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Others</h1>
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane fade show p-0 active">
                                    <div class="job-item p-4 mb-4">
                                        <?php
                                            $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 AND jobCategory = 'Others' ORDER BY 'jobTitle'";
                        ...
                        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane fade show p-0 active">
                                    <div class="job-item p-4 mb-4">
                                        <?php
                                            $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 AND jobCategory = 'Others' AND jobNature = 'Full Time' ORDER BY 'jobTitle'";
                                            $getJobsResult = mysqli_query($conn, $getJobs);
                        ...
                        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane fade show p-0 active">
                                    <div class="job-item p-4 mb-4">
                                        <?php
                                            $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 AND jobCategory = 'Others' AND jobNature = 'Part Time' ORDER BY 'jobTitle'";
                                            $getJobsResult = mysqli_query($conn, $getJobs);
