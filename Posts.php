                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto p-4 p-lg-0">
                            ...
                            <a href="Posts.php" class="nav-item nav-link active">Posts</a>
        ...
        <!-- Header Start -->
            <div class="container-xxl py-5 bg-dark page-header mb-5">
                <div class="container my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Posts</h1>
                </div>
            </div>
        <!-- Header End -->
                            ...
                            if($image == ""){
                                ...
                                <div style="background-color: #EFFDF5; display: flex; flex-direction: column; width: 100%; height: auto; padding: 20px 0px 20px 20px;">
                                    ...
                                    <div style="width: 100%; padding: 20px;">
                                        <a href="ViewTalentProfile.php?talentId=' . $talentId . '"><button class="btn btn-primary" style="padding: 10px; width: 100%;">View Talent Profile</button></a>
                                    </div>
                                </div></br></br>';
                            }
                            else{
