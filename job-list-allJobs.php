    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Jobs - All Jobs</h1>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px; display: flex; justify-content: center; align-items: center;">
                <form action="" method="GET" style="display: flex; align-items: center; justify-content: center; width: 100%;">
                    <input type="text" name="search" placeholder = "Search Jobs" class="form-control border-0" style="width: 25%;" value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>">
            ...
            <?php 
                if(isset($_GET['search'])) { 
                                        ...
                                        <div class="tab-content">
                                            <div id="tab-1" class="tab-pane fade show p-0 active">
                                                <div class="job-item p-4 mb-4">
                                                    <?php
                                                        $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 ORDER BY 'jobTitle'";
                                    ...
                                    <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="tab-content">
                                            <div id="tab-1" class="tab-pane fade show p-0 active">
                                                <div class="job-item p-4 mb-4">
                                                    <?php
                                                        $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 AND jobNature = 'Full Time' ORDER BY 'jobTitle'";
                                                        $getJobsResult = mysqli_query($conn, $getJobs);
                                    ...
                                    <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="tab-content">
                                            <div id="tab-1" class="tab-pane fade show p-0 active">
                                                <div class="job-item p-4 mb-4">
                                                    <?php
                                                        $getJobs = "SELECT * FROM jobs WHERE isAvailable = 1 AND jobNature = 'Part Time' ORDER BY 'jobTitle'";
                                                        $getJobsResult = mysqli_query($conn, $getJobs);
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM jobs WHERE CONCAT(jobTitle, jobDescription, jobResponsibility) LIKE '%$filterValues%'";

                        $queryResult = mysqli_query($conn, $query);

                        if(mysqli_num_rows($queryResult) > 0) {
                            foreach($queryResult as $jobs) {
                                $recruiterIdForLogo = $jobs['recruiterId'];
                                $getImage = "SELECT image FROM recruiters WHERE recruiterId = $recruiterIdForLogo";
                                $getImageResult = mysqli_query($conn, $getImage);
                                $image = "";
                                if ($getImageResult && mysqli_num_rows($getImageResult) > 0) {
                                    $imageRow = mysqli_fetch_assoc($getImageResult);
                                                    ...
                                                    <div class="job-item p-4 mb-4">
                                                        <div class="row g-4">
                                                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                                                <img class="flex-shrink-0 img-fluid border rounded" src="<?= $image ?>" alt="Company Logo" style="width: 80px; height: 80px;">
                                                                <div class="text-start ps-4">
                                                                    <h5 class="mb-3"><?= $jobs['jobTitle']; ?></h5>
                                                                    <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><?= $jobs['jobLocation']; ?></span>
                                                                    <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i><?= $jobs['jobNature']; ?></span>
                                                                    <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i><?= $jobs['pay']; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                                <div class="d-flex mb-3">
                                                                    <a class="btn btn-primary" href="job-detail.php?jobId=<?= $jobs['jobId']; ?>">Details</a>
                                                                </div>
                                                                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: <?= $jobs['dateLine']; ?></small>
                                                            </div>
                                                        </div></br></br>
                                                    </div>
                                                </div>
                            ...
                            <div style="display: flex; align-items: center; justify-content: center;">
                                <p style="padding: 50px">Job not found</p>
                            </div>
                            <?php
                        }
                    }
